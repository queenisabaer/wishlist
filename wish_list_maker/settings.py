"""
Django settings for wish_list_maker project.
...
ALLOWED_HOSTS = ["127.0.0.1:8000", "localhost", "127.0.0.1", ".herokuapp.com"]
...
# Cloudinary Settings (used a tutorial by Daisy Mc Girr to add this)
